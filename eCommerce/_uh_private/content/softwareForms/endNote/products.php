   ...
   $sql = mysqli_query($con, "SELECT * FROM agreement_form WHERE uh_username = '$username';"); 
       while ($row = mysqli_fetch_array($sql)){
           if( empty ($row['endNote'])){
                   header ("Location:?section=endNoteAgreement");
           }
...
<body>
    ...
    <div id="right">
    <center>
        <img src="https://software.psu.edu/cms/default/assets/Image/Home%20Page/Students/Main%20Banner/endnote.jpg" width="500" height="250">
    </center>
    <div class="products">
	...
	$results = mysqli_query($con, "SELECT * FROM products LIMIT 56,4;");//Collect data from products table
            if ($results) {
