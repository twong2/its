...
<div id="products-wrapper">
    <div id="right">
        <center><img src="http://download.microsoft.com/download/B/1/0/B102AB56-BB7E-4BCF-9D80-1278A029F95A/MSFT_logo_png.png" width="500" height="200"></center>
    <h1>Applications</h1>
    <div class="products">
	...
	$results = mysqli_query($con, "SELECT * FROM products LIMIT 10,13;");//Collect data from products table
            if ($results) {
