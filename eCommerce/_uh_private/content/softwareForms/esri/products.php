           ...
           while ($row = mysqli_fetch_array($sql)){
               if( empty ($row['esri'])){
                   echo '<b>Please read and sign to continue</b>';
                       header ("Location:?section=esriAgreement");
                    }
...
<body>
    ...
    <div id="right">
    <center>
        <img src="http://gisandscience.files.wordpress.com/2010/05/new-esri-logo.gif?w=676" width="500" height="250">
    </center>
    <div class="products">
	...
	$results = mysqli_query($con, "SELECT * FROM products LIMIT 60,2;");//Collect data from products table
            if ($results) {
