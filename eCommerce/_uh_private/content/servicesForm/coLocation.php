...
<h2>Your Shopping Cart</h2>
    ...
    <?php
        if(isset($_SESSION["products"]))
        {
            ...
            echo '<a href="?section=serviceReview">Send to Review</a><br>';
